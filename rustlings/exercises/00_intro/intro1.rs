...
// Figured out that, rustlings.exe is having a module that keeps reading the
// files in this folder and and keeps compiling them, and printing out 
fn main() {
    println!("Hello and");
    ...
    println!(r#"                               |___/      "#);
    println!();
    println!(r#"Want to see what is happening"#);
    println!(r#"Raw strings have a # in the begin and end."#);
